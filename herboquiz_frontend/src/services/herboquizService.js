...
export const animationService = {
  ...
  penalite: (mancheId, payload) =>
    api.post(`/manches/${mancheId}/penalite`, payload).then((r) => r.data),
}
...
export const participantService = {
  ...
  eliminer: (id) => api.post(`/participants/${id}/eliminer`).then((r) => r.data),
...
export const equipeService = {
  ...
  creer: (participants) => api.post('/equipes', { participants }).then((r) => r.data),
  modifier: (id, participants) => api.put(`/equipes/${id}`, { participants }).then((r) => r.data),
  supprimer: (id) => api.delete(`/equipes/${id}`).then((r) => r.data),
  eliminer: (id) => api.post(`/equipes/${id}/eliminer`).then((r) => r.data),
}
...
export const simulationService = {
  ...
  retirer: () => api.post('/simulation/retirer').then((r) => r.data),
}
